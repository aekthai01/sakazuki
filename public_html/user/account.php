...
<head>
    ...
    <title data-lang="account.title"><?php echo Lang::t('account.title'); ?></title>
    ...
    <main class="p-6 max-w-3xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold flex items-center gap-2">
                <i class="bi bi-person-gear text-blue-400"></i>
        ...
        <div class="glass rounded-xl p-6">
            <form method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="text-gray-400 text-sm mb-2 block" data-lang="login.username"><?php echo Lang::t('login.username'); ?></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="password" name="new_password"
                               class="glass border border-white/10 rounded-lg p-2 w-full bg-transparent text-white"
                               data-lang-placeholder="admin.settings.new_password_hint"
                               placeholder="<?php echo Lang::t('admin.settings.new_password_hint'); ?>">
                    </div>
                    <div>
                        ...
                        <input type="password" name="confirm_password"
                               class="glass border border-white/10 rounded-lg p-2 w-full bg-transparent text-white"
                               data-lang-placeholder="register.confirm_password.placeholder"
                               placeholder="<?php echo Lang::t('register.confirm_password.placeholder'); ?>">
                    </div>
                </div>
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg font-medium transition flex items-center gap-2">
