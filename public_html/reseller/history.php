...
$purchaseHistory = function_exists('cgoGetUnifiedPurchaseGroupsPage')
    ? cgoGetUnifiedPurchaseGroupsPage($userId, 'reseller', $historyPerPage, $historyOffset, $historySearch)
    : cgoGetUnifiedPurchaseGroups($userId, 'reseller');
...
<head>
    ...
    <title data-lang="history.title"><?php echo Lang::t('history.title'); ?> - Reseller</title>
...
<body class="bg-[#0b101e] text-gray-100 min-h-screen pb-10">
    ...
    <main class="max-w-md mx-auto p-4 space-y-4 pt-6">
        ...
        <div class="bg-[#161c2d] border border-white/5 rounded-xl p-4 flex justify-between items-center shadow-md">
            <div class="flex items-center gap-3">
                <div
                    class="bg-[#22c55e] text-white w-9 h-9 rounded-full flex items-center justify-center font-bold text-lg">
        ...
        <!-- Detail Modal -->
        <div class="fixed inset-0 bg-black/80 backdrop-blur-sm z-[1000] hidden items-center justify-center p-4"
            id="detailModalOverlay" aria-hidden="true">
            <div class="bg-[#1b2336] rounded-xl overflow-hidden shadow-2xl w-full max-w-[340px] transform transition-all"
                id="detailModal" role="dialog" aria-modal="true" tabindex="-1">
                <div class="p-5 pb-3 flex justify-between items-center">
                    ...
                    <button type="button" aria-label="Close" onclick="closeDetailModal()"
                ...
                <div class="p-5 pt-0 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="bg-[#121827] border border-white/5 rounded-lg p-3 text-gray-300 font-mono text-[14px] break-all max-h-32 overflow-y-auto"
                            id="modalKeys">
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="pt-2 space-y-2">
                        <button type="button" onclick="copyModalKeys()"
                            class="w-full bg-[#22c55e] hover:bg-green-600 text-white rounded-lg py-2.5 text-[14px] font-medium flex items-center justify-center gap-2 transition"
                            id="modalCopyBtn">
                            <i class="bi bi-intersect"></i> <span data-lang="common.copy"><?php echo Lang::t('common.copy'); ?></span>
                        </button>
                        <a href="#" target="_blank" id="modalDownloadBtn"
                            class="w-full bg-gradient-to-r from-[#ef4444] to-[#f97316] hover:opacity-90 text-white rounded-lg py-2.5 text-[14px] font-medium flex items-center justify-center gap-2 transition hidden">
                            <i class="bi bi-download"></i> <span data-lang="common.download"><?php echo Lang::t('common.download'); ?></span>
                        </a>
                        <button type="button" onclick="closeDetailModal()"
                            class="w-full bg-[#2a3454] hover:bg-[#323d60] text-gray-300 rounded-lg py-2.5 text-[14px] font-medium transition">
                            <span data-lang="common.close"><?php echo Lang::t('common.close'); ?></span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div id="keysList" class="px-4 pb-4 space-y-3">
                <?php if (empty($groupedPurchases)): ?>
                    <div class="text-center py-8 text-gray-500 text-sm">
                        ...
                        <span data-lang="history.empty"><?php echo Lang::t('history.empty'); ?></span>
                    </div>
                <?php else: ?>
                        ...
                        <div class="bg-[#1b233d] border border-white/5 rounded-xl p-3.5 key-item"
                            ...
                            <div class="flex justify-between items-start mb-1">
                                <div class="flex items-center gap-2 flex-wrap">
                                    ...
                                    <?php if ($qty > 1): ?>
                                        <span
                                            class="bg-[#22c55e]/20 text-[#22c55e] text-[10px] font-bold px-1.5 py-0.5 rounded">x<?php echo $qty; ?></span>
                                    <?php endif; ?>
                                    <?php if ($isLatest): ?>
                                        <span
                            ...
                            <div class="flex justify-between items-center mb-3">
                                ...
                                <div class="text-gray-400 text-[11px]">
                                    <span data-lang="history.main_balance"><?php echo Lang::t('history.main_balance'); ?></span> <span
                                        class="text-[#22c55e] ml-0.5"><?php echo formatCurrency($group['balance_after'] ?? 0); ?></span>
                                </div>
                            </div>
                                        ...
                                        <div class="flex items-center justify-between gap-3 px-3 py-2.5 border-b border-white/5 bg-white/[0.02]">
                                            <div class="min-w-0">
                                                <div class="flex items-center gap-2 text-[13px] font-semibold text-gray-200">
                                                    <i class="bi bi-person-vcard text-[#22c55e]"></i>
                                            ...
                                            <button type="button"
                                                ...
                                                class="bg-[#22c55e] hover:bg-[#16a34a] text-white rounded-lg px-3 h-[34px] text-[12px] flex items-center justify-center gap-1.5 transition whitespace-nowrap">
                                                <i class="bi bi-copy"></i>
                                                <span data-lang="common.copy_all"><?php echo Lang::t('common.copy_all'); ?></span>
                                            </button>
                                        </div>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="flex items-center gap-2 mt-2">
                                        ...
                                        <button type="button"
                                            ...
                                            class="bg-[#22c55e] hover:bg-[#16a34a] text-white rounded-lg px-3 h-[38px] text-[13px] flex w-auto items-center justify-center gap-1.5 transition whitespace-nowrap">
                                        ...
                                        <div class="hidden-keys mt-2 space-y-2">
                                            ...
                                            <div class="flex gap-2 mt-2 pt-1">
                                                <button type="button" onclick="Lang.copy(this.getAttribute('data-keys'))"
                                                    ...
                                                    class="bg-[#22c55e] hover:bg-[#16a34a] text-white rounded-lg h-[38px] px-4 text-[13px] flex-1 flex items-center justify-center gap-1.5 transition">
                                                    <i class="bi bi-intersect"></i> <span class="btn-text" data-lang="common.copy_all"><?php echo Lang::t('common.copy_all'); ?></span>
                                                </button>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function copyModalKeys() {
            Lang.copy(window.currentModalKeys);
        }
